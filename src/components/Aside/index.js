                ...
                <div className='menu-aside'>
                    ...
                    <div className='menu'>
                        <ul>
                            ...
                            <li><img className='icon-aside' src="../database-management.png" alt="" /><Link to='/list' className='link-aside'>Dados Armazenados</Link></li>
                        </ul>
                        <button onClick={hundleLogout} >Deslogar</button>
                    </div>
                </div>
            </div>
